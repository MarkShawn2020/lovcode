...
const COMMAND_ROUTES: Record<string, CommandRoute> = {
  ...
  get_maas_runtime_config_status: { command: "maas_command", action: "get_maas_runtime_config_status" },
  restore_provider_context: { command: "maas_command", action: "restore_provider_context" },
  snapshot_codex_maas_provider: { command: "maas_command", action: "snapshot_codex_maas_provider" },
